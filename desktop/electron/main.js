...
// secure.js подключаем мягко: если файл не попал в asar (битая сборка/карантин),
// приложение не падает при старте — шифрование просто не активируется.
let secure = null;
try {
  secure = require("./secure");
} catch (e) {
  console.warn("[main] secure.js недоступен:", e && e.message ? e.message : e);
}
