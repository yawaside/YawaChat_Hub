...
const APP_CONFIG = {
  ...
  twitch: {
    ...
    clientSecret: "",
    /** Scopes: чтение/отправка чата, модерация, подписки, отслеживания и награды за баллы. */
    scopes: [
      "chat:read",
      "chat:edit",
  ...
  vk: {
    ...
    // Классические права; vkid.personal_info добавляется VK автоматически, если scope пуст.
    scopes: ["offline"],
  },
