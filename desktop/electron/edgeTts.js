  ...
  connecting = new Promise((resolve, reject) => {
    ...
    try {
      ws = new WebSocket(
        ...
        {
          // Тот же аккуратный TLS, что и у чат-коннекторов: обычная проверка
          // сертификата, поблажка только при локальной инспекции у доверенных
          // хостов Microsoft. Раньше это работало лишь потому, что проверка была
          // отключена во всём процессе.
          agent: chatAgent,
