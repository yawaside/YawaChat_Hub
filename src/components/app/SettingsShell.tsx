...
import {
  Ban, Bot, Gamepad2, Info, Keyboard, LayoutList, Menu, Palette, Search,
...
export type SettingsTabId =
  | "voice" | "filters" | "chatview" | "widget" | "overlay" | "hotkeys" | "bot" | "interface" | "about";
...
export const SETTINGS_TABS: TabMeta[] = [
  ...
  {
    id: "bot", label: "Чат-бот", short: "Чат-бот",
    desc: "Подключения каналов, команды, модерация, DonationAlerts",
    icon: Bot, keys: ["бот", "chat bot", "чат-бот", "twitch", "vk", "вк", "команды", "команда", "бан", "таймаут", "модерация", "donationalerts", "донат", "донаты", "oauth", "токен", "отслеживание", "подписка", "подписки", "follow", "subscribe", "валюта", "сумма донатов", "вебхук", "webhook"],
  },
  {
...
export const SETTINGS_GROUPS: Array<{ id: string; label: string; tabs: SettingsTabId[] }> = [
  ...
  { id: "system", label: "Система", tabs: ["hotkeys", "bot", "interface", "about"] },
];
